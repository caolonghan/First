...
var IMULerp = function (obj) {
    return {
        resetPos:{x:0,z:0,y:0},resetRotation:{x:0,y:0,z:0},resetScale:{x:1,y:1,z:1},LerpSpeed:0.05,
        setResetTransform:function(t){
           this.resetPos= t.position;
           this.resetRotation = t.rotationXYZ;
        ...
        frame++;
                if(sceneManager.imuTarget["useReset"] == true)
                {
                    if(num < 3)
                    {
                        if(frame > 15)
        ...
        if(num == 0)
        {
            obj.transform.position = add(obj.transform.position,v_lerp(obj.transform.position,this.resetPos,this.LerpSpeed));
            obj.transform.rotationXYZ = add(obj.transform.rotationXYZ,v_lerp(obj.transform.rotationXYZ,this.resetRotation,this.LerpSpeed));
            obj.transform.scale = add(obj.transform.scale,v_lerp(obj.transform.scale,this.resetScale,this.LerpSpeed));
